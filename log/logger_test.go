...
func TestZapLogger(t *testing.T) {
	...
	ts.AssertMessages(
		`{"level":"info","msg":"received work order","Key":"Key Field",`+getStackCaller(24, "")+`}`,
		`{"level":"debug","msg":"starting work","Key":"Key Field",`+getStackCaller(25, "")+`}`,
		`{"level":"warn","msg":"work may fail","Key":"Key Field",`+getStackCaller(26, "")+`}`,
		`{"level":"error","msg":"work failed","Key":"Key Field",`+getStackCaller(27, "")+`}`,
		`{"level":"panic","msg":"failed to do work","Error":"Should panic",`+getStackCaller(30, ".func1")+`}`,
	)
}
